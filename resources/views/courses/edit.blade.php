                ...
                <div class="offset-3 col-lg-6">
                    ...
                    <div class="card">
                        <div class="card-header">
                            <strong>Edit course </strong> {{$course->name}}
                        </div>
                        <div class="card-body card-block">
                            ...
                            <form action="{{route('courses.update',$course->id)}}" method="post" class="">
                                ...
                                <div class="form-group">
                                    ...
                                    <select name="campuse_id" class="form-control">
                                        @foreach($campuses as $campus)
                                            <option value="{{$campus->id}}" {{$course->campuse_id == $campus->id ? 'selected' : ''}}>
                                                {{$campus->name}}
                                            </option>
                                        @endforeach
                                    </select>
                                ...
                                <div class="card">
                                    <div class="card-header">
                                        <strong class="card-title">Old Selected Types</strong>
                                    </div>
                                    <div class="card-body">
                                ...
                                <div class="card">
                                    <div class="card-header">
                                        <strong class="card-title">Select a new types</strong>
                                    </div>
                                    <div class="card-body">
